...
@NoArgsConstructor
@AllArgsConstructor
public class CampaignFormQueryRs extends ApiResponsePayload implements Serializable {
    private static final long serialVersionUID = 1L;

    @Schema(title = "活動表單清單", description = "活動表單清單")
    private List<CampaignFormInfo> campaignFormInfoList;
