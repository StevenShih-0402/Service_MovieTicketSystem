...
@NoArgsConstructor
@AllArgsConstructor
public class CampaignCreateRq extends ApiRequestPayload implements Serializable {
    ...
    public static class CampaignRuleSetting {
        ...
        @Schema(title = "交易欄位設定主鍵", description = "交易欄位設定主鍵", example = "1")
        private BigInteger transactionPayloadConfigId;

        @Schema(title = "交易網址設定主鍵", description = "交易網址設定主鍵", example = "1")
