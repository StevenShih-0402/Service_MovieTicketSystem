package com.ctbcbank.navi.mid.campaign.management.controller.campaignform.payload.createcomment;
...
@NoArgsConstructor
@AllArgsConstructor
public class CampaignFormCreateCommentRs extends ApiResponsePayload implements Serializable {
    ...
    @Schema(title = "活動表單備註", description = "活動表單備註", example = "測試備註欄")
