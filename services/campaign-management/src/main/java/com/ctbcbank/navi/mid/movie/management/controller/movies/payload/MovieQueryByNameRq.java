...
@NoArgsConstructor
@AllArgsConstructor
public class MovieQueryByNameRq extends ApiRequestPayload implements Serializable {
    private static final long serialVersionUID = 1L;

    @NotBlank
    @Schema(title = "電影關鍵字", description = "電影關鍵字")
    ...
    @Positive
    @NotNull
    @Schema(title = "分頁頁數", description = "指定要取得第幾頁的資訊", example = "1")
