...
@NoArgsConstructor
@AllArgsConstructor
public class CampaignQueryByCampaignIdRs extends ApiResponsePayload implements Serializable {
...
//        @JsonSerialize(using = CustomDateTimeAsiaTaipeiSerialize.class)
...
//        @JsonSerialize(using = CustomDateTimeAsiaTaipeiSerialize.class)
    ...
    public static class CampaignRuleSetting {
        ...
        @Schema(title = "是否為規則設定", description = "True: 規則設定, False: 規則額外設定", example = "true")
        @JsonProperty("isRuleSetting")
