...
@NoArgsConstructor
@AllArgsConstructor
public class CampaignQueryCouponTemplateRs extends ApiResponsePayload implements Serializable {
    private static final long serialVersionUID = 1L;

    @Schema(title = "活動優惠券樣板清單", description = "活動優惠券樣板清單")
    private List<CampaignCouponTemplate> campaignCouponTemplateList;

    @Data
    @SuperBuilder
    @NoArgsConstructor
    @AllArgsConstructor
    public static class CampaignCouponTemplate {
