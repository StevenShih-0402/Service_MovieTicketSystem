package com.ctbcbank.navi.mid.campaign.management.controller.campaignform.payload.review;
...
@NoArgsConstructor
@AllArgsConstructor
public class CampaignFormReviewRq extends ApiRequestPayload implements Serializable {
    ...
    @NotNull
    @Schema(title = "審核狀態", description = "審核狀態")
